#python menu driven program for classical ciphers encryption and decryption
...
def hill_cipher_decryption():
    ...
    inverse_key[0][1] = -(key_matrix[1][0] * key_matrix[2][2] - key_matrix[2][0] * key_matrix[1][2])/determinant
    inverse_key[0][2] = (key_matrix[1][0] * key_matrix[2][1] - key_matrix[2][0] * key_matrix[1][1])/determinant
    inverse_key[1][0] = -(key_matrix[0][1] * key_matrix[2][2] - key_matrix[2][1] * key_matrix[0][2])/determinant
    inverse_key[1][1] = (key_matrix[0][0] * key_matrix[2][2] - key_matrix[2][0] * key_matrix[0][2])/determinant
    inverse_key[1][2] = -(key_matrix[0][0] * key_matrix[2][1] - key_matrix[2][0] * key_matrix[0][1])/determinant
    inverse_key[2][0] = (key_matrix[0][1] * key_matrix[1][2] - key_matrix[1][1] * key_matrix[0][2])/determinant
    inverse_key[2][1] = -(key_matrix[0][0] * key_matrix[1][2] - key_matrix[1][0] * key_matrix[0][2])/determinant
